...
/**
 * The AbstractCompanyDao class will maintain the persistence of Company class into
 * the companies table.
 */
abstract class AbstractCompanyDao
{
    ...
    /**
     * Get a Company filtered by code.
     *
     * @param string $code
     * @param string[] $additionalTablesFetch A list of additional tables to fetch (for performance improvement)
     * @return \App\Domain\Model\Company|null
     */
    public function findOneByCode(string $code, array $additionalTablesFetch = []) : ?\App\Domain\Model\Company
    {
        $filter = [
                    'code' => $code,
                ];
