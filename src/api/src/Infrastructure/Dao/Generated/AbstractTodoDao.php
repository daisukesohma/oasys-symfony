 ...
 * If you need to perform changes, edit the TodoDao class instead!
 */
...
/**
 * The AbstractTodoDao class will maintain the persistence of Todo class into the
 * todos table.
 */
abstract class AbstractTodoDao
{
    ...
    /**
     * Persist the Todo instance.
     *
     * @param Todo $obj The bean to save.
     */
    public function save(\App\Domain\Model\Todo $obj) : void
    {
     ...
     *
     * @return \App\Domain\Model\Todo[]|\TheCodingMachine\TDBM\ResultIterator
     */
    public function findAll() : \TheCodingMachine\TDBM\ResultIterator
    {
        if ($this->defaultSort) {
            $orderBy = 'todos.'.$this->defaultSort.' '.$this->defaultDirection;
        } else {
            $orderBy = null;
        }
        return $this->tdbmService->findObjects('todos', null, [], $orderBy);
    }

    /**
     * Get Todo specified by its ID (its primary key).
     *
     * If the primary key does not exist, an exception is thrown.
     *
     * @param string $id
     * @param bool $lazyLoading If set to true, the object will not be loaded right away. Instead, it will be loaded when you first try to access a method of the object.
     * @return \App\Domain\Model\Todo
     ...
     */
    public function getById(string $id, bool $lazyLoading = false) : \App\Domain\Model\Todo
    {
        return $this->tdbmService->findObjectByPk('todos', ['id' => $id], [], $lazyLoading);
    }

    /**
     * Get all Todo records.
     *
     * @param \App\Domain\Model\Todo $obj The object to delete
     * @param bool $cascade If true, it will delete all objects linked to $obj
     */
    public function delete(\App\Domain\Model\Todo $obj, bool $cascade = false) : void
    {
        if ($cascade === true) {
    ...
    protected function find($filter = null, array $parameters = [], $orderBy = null, array $additionalTablesFetch = [], ?int $mode = null) : \TheCodingMachine\TDBM\ResultIterator
    {
        ...
        return $this->tdbmService->findObjects('todos', $filter, $parameters, $orderBy, $additionalTablesFetch, $mode);
    }

    /**
     * Get a list of Todo specified by its filters.
     *
    ...
    protected function findFromSql(string $from, $filter = null, array $parameters = [], $orderBy = null, array $additionalTablesFetch = [], ?int $mode = null) : \TheCodingMachine\TDBM\ResultIterator
    {
        ...
        return $this->tdbmService->findObjectsFromSql('todos', $from, $filter, $parameters, $orderBy, $mode);
    }

    /**
     * Get a list of Todo from a SQL query.
     *
    ...
    {
        return $this->tdbmService->findObjectsFromRawSql('todos', $sql, $parameters, $mode, null, $countSql);
    }

    /**
     * Get a single Todo specified by its filters.
     *
     * @param mixed $filter The filter bag (see TDBMService::findObjects for complete description)
     * @param mixed[] $parameters The parameters associated with the filter
     * @param string[] $additionalTablesFetch A list of additional tables to fetch (for performance improvement)
     * @return \App\Domain\Model\Todo|null
     */
    protected function findOne($filter = null, array $parameters = [], array $additionalTablesFetch = []) : ?\App\Domain\Model\Todo
    {
        return $this->tdbmService->findObject('todos', $filter, $parameters, $additionalTablesFetch);
    }
     ...
     * @return \App\Domain\Model\Todo|null
     */
    protected function findOneFromSql(string $from, $filter = null, array $parameters = []) : ?\App\Domain\Model\Todo
    {
        return $this->tdbmService->findObjectFromSql('todos', $from, $filter, $parameters);
    }
