 ...
 * If you need to perform changes, edit the QuestionDao class instead!
 */
...
/**
 * The AbstractQuestionDao class will maintain the persistence of Question class
 * into the questions table.
 */
abstract class AbstractQuestionDao
{
    ...
    /**
     * Persist the Question instance.
     *
     * @param Question $obj The bean to save.
     */
    public function save(\App\Domain\Model\Question $obj) : void
    {
     ...
     *
     * @return \App\Domain\Model\Question[]|\TheCodingMachine\TDBM\ResultIterator
     */
    public function findAll() : \TheCodingMachine\TDBM\ResultIterator
    {
        if ($this->defaultSort) {
            $orderBy = 'questions.'.$this->defaultSort.' '.$this->defaultDirection;
        } else {
            $orderBy = null;
        }
        return $this->tdbmService->findObjects('questions', null, [], $orderBy);
    }

    /**
     * Get Question specified by its ID (its primary key).
     *
     ...
     */
    public function getById(string $id, bool $lazyLoading = false) : \App\Domain\Model\Question
    {
        return $this->tdbmService->findObjectByPk('questions', ['id' => $id], [], $lazyLoading);
    }

    /**
     * Get all Question records.
     *
     * @param \App\Domain\Model\Question $obj The object to delete
     * @param bool $cascade If true, it will delete all objects linked to $obj
     */
    public function delete(\App\Domain\Model\Question $obj, bool $cascade = false) : void
    {
        if ($cascade === true) {
    ...
    protected function find($filter = null, array $parameters = [], $orderBy = null, array $additionalTablesFetch = [], ?int $mode = null) : \TheCodingMachine\TDBM\ResultIterator
    {
        ...
        return $this->tdbmService->findObjects('questions', $filter, $parameters, $orderBy, $additionalTablesFetch, $mode);
    }

    /**
     * Get a list of Question specified by its filters.
     *
    ...
    protected function findFromSql(string $from, $filter = null, array $parameters = [], $orderBy = null, array $additionalTablesFetch = [], ?int $mode = null) : \TheCodingMachine\TDBM\ResultIterator
    {
        ...
        return $this->tdbmService->findObjectsFromSql('questions', $from, $filter, $parameters, $orderBy, $mode);
    }

    /**
     * Get a list of Question from a SQL query.
     *
    ...
    {
        return $this->tdbmService->findObjectsFromRawSql('questions', $sql, $parameters, $mode, null, $countSql);
    }

    /**
     * Get a single Question specified by its filters.
     *
     * @param mixed $filter The filter bag (see TDBMService::findObjects for complete description)
     * @param mixed[] $parameters The parameters associated with the filter
     * @param string[] $additionalTablesFetch A list of additional tables to fetch (for performance improvement)
     * @return \App\Domain\Model\Question|null
     */
    protected function findOne($filter = null, array $parameters = [], array $additionalTablesFetch = []) : ?\App\Domain\Model\Question
    {
        return $this->tdbmService->findObject('questions', $filter, $parameters, $additionalTablesFetch);
    }
     ...
     * @return \App\Domain\Model\Question|null
     */
    protected function findOneFromSql(string $from, $filter = null, array $parameters = []) : ?\App\Domain\Model\Question
    {
        return $this->tdbmService->findObjectFromSql('questions', $from, $filter, $parameters);
    }
