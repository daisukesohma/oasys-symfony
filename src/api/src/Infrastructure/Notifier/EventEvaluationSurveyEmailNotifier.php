...
use App\Application\Event\EventEvaluationSurveyNotifier;
...
class EventEvaluationSurveyEmailNotifier implements EventEvaluationSurveyNotifier
{
    ...
    private function sendEmail(Event $event, string $email): void
    {
        ...
        $this->mailer->send($email, 'Enquête d\'évaluation : votre avis nous intéresse !', 'emails/event/event.evaluation.html.twig', [
            ...
            'linkSurvey' => $event->getEvaluationSurvey(),
