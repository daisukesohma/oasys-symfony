...
use App\Application\Event\EventVisioNotifier;
...
class EventVisioEmailNotifier implements EventVisioNotifier
{
    ...
    private function sendEmail(Event $event, string $email): void
    {
        ...
        $this->mailer->send($email, 'Confirmation de votre rendez-vous à distance', 'emails/event/event.with.online.meeting.html.twig', [
