...
final class GetAllProgramsController extends AbstractController
{
     ...
     * @Logged
     */
    public function getAllPrograms(?string $search = null, ?string $status = null, string $sortColumn = 'createdAt', string $sortDirection = 'desc', ?string $candidateId = null): ResultIterator
    {
        /** @var ResultIterator|Program[] $result */
        $result = $this->getAllPrograms->getAll($search, $status, $sortColumn, $sortDirection, $candidateId);
