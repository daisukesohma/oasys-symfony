...
use App\Domain\Enum\QuestionThemeEnum;
...
final class InvalidStringValue extends RuntimeException implements ClientAware, DomainException
{
     ...
     * @throws self
     */
    public static function questionTheme(?string $value, ?string $property = null): void
    {
        if (! in_array($value, QuestionThemeEnum::values())) {
            throw new InvalidStringValue(sprintf('The theme %s is not one of the valid themes', $value), 400);
        }
    }
