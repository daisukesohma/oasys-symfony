...
abstract class AbstractProgram extends \TheCodingMachine\TDBM\AbstractTDBMObject implements JsonSerializable
{
    ...
    public function __construct(string $name, string $description, string $type)
    {
        ...
        $this->setUsersHaveBeenInvited(false);
        $this->setEndSupportEmail(true);
    }
    ...
    {
        return $this->getRef('from__company_id__to__table__companies__columns__id', 'programs');
    }
    ...
    {
        $this->setRef('from__company_id__to__table__companies__columns__id', $object, 'programs');
    }
    ...
    /**
     * The getter for the "period" column.
     *
     * @return int|null
     * @GraphqlField
     */
    ...
    {
        return $this->get('period', 'programs');
    }

    /**
     * The setter for the "period" column.
     *
     * @param int|null $period
     */
    public function setPeriod(?int $period) : void
    {
        $this->set('period', $period, 'programs');
    }

    /**
     * The getter for the "users_have_been_invited" column.
     *
     * @return bool
     * @GraphqlField
     */
    public function getUsersHaveBeenInvited() : bool
    {
        return $this->get('users_have_been_invited', 'programs');
    }

    /**
     * The setter for the "users_have_been_invited" column.
     *
     * @param bool $users_have_been_invited
     */
    public function setUsersHaveBeenInvited(bool $users_have_been_invited) : void
    {
        $this->set('users_have_been_invited', $users_have_been_invited, 'programs');
    }

    /**
     * The getter for the "end_support_email" column.
     *
     * @return bool
     * @GraphqlField
     */
    public function getEndSupportEmail() : bool
    {
        return $this->get('end_support_email', 'programs');
    }

    /**
     * The setter for the "end_support_email" column.
     *
     * @param bool $end_support_email
     */
    public function setEndSupportEmail(bool $end_support_email) : void
    {
        $this->set('end_support_email', $end_support_email, 'programs');
    }
    ...
    /**
     * Returns the list of Question pointing to this bean via the program_id column.
     *
     * @return Question[]|\TheCodingMachine\TDBM\AlterableResultIterator
     * @GraphqlField
     */
    public function getQuestions() : \TheCodingMachine\TDBM\AlterableResultIterator
    {
        return $this->retrieveManyToOneRelationshipsStorage('questions', 'from__program_id__to__table__programs__columns__id', ['questions.program_id' => $this->get('id', 'programs')]);
    }

    /**
     * Returns the list of Todo pointing to this bean via the program_id column.
     *
     * @return Todo[]|\TheCodingMachine\TDBM\AlterableResultIterator
     * @GraphqlField
     */
    public function getTodos() : \TheCodingMachine\TDBM\AlterableResultIterator
    {
        return $this->retrieveManyToOneRelationshipsStorage('todos', 'from__program_id__to__table__programs__columns__id', ['todos.program_id' => $this->get('id', 'programs')]);
    }

    /**
     * Returns the list of Document associated to this bean via the documents_programs pivot table.
     *
    ...
    {
        return $this->_getRelationships('documents_programs.program_id');
    }

    /**
     * Adds a relationship with Document associated to this bean via the documents_programs pivot table.
     *
     * @param \App\Domain\Model\Document $document
     */
    public function addDocument(\App\Domain\Model\Document $document) : void
    {
        $this->addRelationship('documents_programs', $document);
    }

    /**
     * Deletes the relationship with Document associated to this bean via the documents_programs pivot table.
     *
     * @param \App\Domain\Model\Document $document
     */
    public function removeDocument(\App\Domain\Model\Document $document) : void
    {
        $this->_removeRelationship('documents_programs', $document);
    }

    /**
     * Returns whether this bean is associated with Document via the documents_programs pivot table.
     *
     * @param \App\Domain\Model\Document $document
     * @return bool
     */
    ...
    {
        return $this->hasRelationship('documents_programs.program_id', $document);
    }

    /**
     * Sets all relationships with Document associated to this bean via the documents_programs pivot table.
    ...
    {
        $this->setRelationships('documents_programs.program_id', $documents);
    }

    /**
     * Returns the list of User associated to this bean via the programs_coaches pivot table.
     *
     * @return \App\Domain\Model\User[]
     */
    public function getUsersByProgramsCoaches() : array
    {
        return $this->_getRelationships('programs_coaches.program_id');
    }

    /**
     * Adds a relationship with User associated to this bean via the programs_coaches pivot table.
     *
     * @param \App\Domain\Model\User $user
     */
    public function addUserByProgramsCoaches(\App\Domain\Model\User $user) : void
    {
        $this->addRelationship('programs_coaches', $user);
    }

    /**
     * Deletes the relationship with User associated to this bean via the programs_coaches pivot table.
     *
     * @param \App\Domain\Model\User $user
     */
    public function removeUserByProgramsCoaches(\App\Domain\Model\User $user) : void
    {
        $this->_removeRelationship('programs_coaches', $user);
    }

    /**
     * Returns whether this bean is associated with User via the programs_coaches pivot table.
     *
     * @param \App\Domain\Model\User $user
     * @return bool
     */
    public function hasUserByProgramsCoaches(\App\Domain\Model\User $user) : bool
    {
        return $this->hasRelationship('programs_coaches.program_id', $user);
    }

    /**
     * Sets all relationships with User associated to this bean via the programs_coaches pivot table.
     * Exiting relationships will be removed and replaced by the provided relationships.
     *
     * @param \App\Domain\Model\User[] $users
     * @return void
     */
    public function setUsersByProgramsCoaches(array $users) : void
    {
        $this->setRelationships('programs_coaches.program_id', $users);
    }
     ...
     * @param \App\Domain\Model\User $user
     */
    public function addUserByProgramsUsers(\App\Domain\Model\User $user) : void
    {
     ...
     * @param \App\Domain\Model\User $user
     */
    public function removeUserByProgramsUsers(\App\Domain\Model\User $user) : void
    {
     ...
     * @return bool
     */
    public function hasUserByProgramsUsers(\App\Domain\Model\User $user) : bool
    {
     ...
     * @return void
     */
    public function setUsersByProgramsUsers(array $users) : void
    {
    ...
    {
        switch ($pathKey) {
            case 'documents_programs.program_id':
                return new \TheCodingMachine\TDBM\Utils\ManyToManyRelationshipPathDescriptor('documents', 'documents_programs', ['id'], ['document_id'], ['program_id']);
            case 'programs_coaches.program_id':
                return new \TheCodingMachine\TDBM\Utils\ManyToManyRelationshipPathDescriptor('users', 'programs_coaches', ['id'], ['coach_id'], ['program_id']);
    ...
    {
        return array_merge(parent::_getManyToManyRelationshipDescriptorKeys(), ['documents_programs.program_id', 'programs_coaches.program_id', 'programs_users.program_id']);
    }
    ...
    public function jsonSerialize(bool $stopRecursion = false)
    {
        ...
        $array['period'] = $this->getPeriod();
        $array['usersHaveBeenInvited'] = $this->getUsersHaveBeenInvited();
        $array['endSupportEmail'] = $this->getEndSupportEmail();
        if (!$stopRecursion) {
        ...
        if (!$stopRecursion) {
            $array['usersByProgramsCoaches'] = array_map(function (User $object) {
                return $object->jsonSerialize(true);
            }, $this->getUsersByProgramsCoaches());
        };
        if (!$stopRecursion) {
            $array['usersByProgramsUsers'] = array_map(function (User $object) {
                return $object->jsonSerialize(true);
            }, $this->getUsersByProgramsUsers());
        };
        return $array;
    }
    ...
    public function onDelete() : void
    {
        ...
        $this->setRef('from__company_id__to__table__companies__columns__id', null, 'programs');
    }
