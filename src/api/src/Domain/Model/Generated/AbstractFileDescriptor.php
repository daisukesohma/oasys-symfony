...
abstract class AbstractFileDescriptor extends \TheCodingMachine\TDBM\AbstractTDBMObject implements JsonSerializable
{
    ...
    /**
     * Returns the list of Company pointing to this bean via the functions_services_file_id column.
     *
    ...
    {
        return $this->retrieveManyToOneRelationshipsStorage('companies', 'from__functions_services_file_id__to__table__file_descriptors__columns__id', ['companies.functions_services_file_id' => $this->get('id', 'file_descriptors')]);
    }
     ...
     * @GraphqlField
     */
    public function getUsersByProfilePictureId() : \TheCodingMachine\TDBM\AlterableResultIterator
    {
    ...
    /**
     * Returns the list of User pointing to this bean via the cv_file_id column.
     *
     * @return User[]|\TheCodingMachine\TDBM\AlterableResultIterator
     * @GraphqlField
     */
    public function getUsersByCvFileId() : \TheCodingMachine\TDBM\AlterableResultIterator
    {
        return $this->retrieveManyToOneRelationshipsStorage('users', 'from__cv_file_id__to__table__file_descriptors__columns__id', ['users.cv_file_id' => $this->get('id', 'file_descriptors')]);
    }
