...
class UploadPictureTest extends ApplicationTestCase
{
    ...
    public function testUploadFile(): void
    {
        ...
        $fileDescriptor = $this->uploadPicture->upload($file, $this->envVarHelper->fetch(EnvVarHelper::ROOT_PATH));
        ...
        $this->uploadPicture->upload($file, $this->envVarHelper->fetch(EnvVarHelper::ROOT_PATH));
    }
}
