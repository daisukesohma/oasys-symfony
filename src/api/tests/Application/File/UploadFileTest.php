...
class UploadFileTest extends ApplicationTestCase
{
    ...
    public function testUploadFile(): void
    {
        ...
        $fileDescriptor = $this->uploadFile->upload($file, $this->envVarHelper->fetch(EnvVarHelper::ROOT_PATH));
        ...
        $this->uploadFile->upload($file, $this->envVarHelper->fetch(EnvVarHelper::ROOT_PATH));
    }
}
