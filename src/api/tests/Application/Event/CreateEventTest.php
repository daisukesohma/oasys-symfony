...
class CreateEventTest extends ApplicationTestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $redisMock = $this->getMockBuilder(RedisClient::class)
            ...
            ->getMock();
        self::$container->set(RedisClient::class, $redisMock);
    ...
    public function testCreateEvent(): void
    {
        ...
        $dateEventAfter = $this->faker->dateTimeBetween('+31 days', '+60 days');
        ...
        $event = $this->createEvent->create(
            ...
            $dateEventAfter->format(DateTimeImmutable::ISO8601),
    ...
    public function testInvalidOrganizer(): void
    {
        ...
        $this->createEvent->create(
            ...
            $this->faker->dateTimeBetween('+31 days', '+60 days')->format(DateTimeImmutable::ISO8601),
            $this->eventModel->getId(),
        );
    }
