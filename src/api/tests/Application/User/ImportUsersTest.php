...
class ImportUsersTest extends ApplicationTestCase
{
    ...
    {
        $data = [
            ['Civility', 'First Name', 'Last Name', 'Email', 'Phone', 'Type', 'Role(s)', 'Company Name', 'Coach Email', 'Actif', 'Address', 'LinkedIn', 'Function', 'Previous Function', 'Seniority Date', 'Type prestation'],
            ['M', 'Test', 'User', 'test@user.com', '123123123', 'Candidat', 'Administrateur', 'Test Company Name', $this->loggedUser->getEmail(), 'oui', '123 Paris', 'https://linkedin.com/in/test', 'Test Function', 'Test Prev Function', '28/01/2019', 'Coaching individuel', 'Test', 'Name', 'test@example.com', '0123123123'],
            ['M', 'Second', 'User', 'second@user.com', '234234234', 'Candidat', 'Administrateur', 'Test Company Name', $this->loggedUser->getEmail(), 'oui', '123 Paris new street', 'https://linkedin.com/in/test2', 'Test Function 2', 'Test Prev Function 2', '01/01/2019', 'Coaching individuel', 'Test', 'Name', 'test@example.com', '0123123123'],
        ];

        $file = $this->generateTestFile($data);

        $users = $this->importUsers->import($file, $this->envVarHelper->fetch(EnvVarHelper::ROOT_PATH));
        ...
        foreach ($users as $i => $user) {
            ...
            $this->assertEquals($row[15], $user->getProgramType());
        }
    }
    ...
    public function testImportErrorDuplicateUser(): void
    {
        $data = [
            ...
            ['M', 'Test', 'User', $this->loggedUser->getEmail(), '123123123', 'Candidat', 'Administrateur', 'Test Company Name', $this->loggedUser->getEmail(), 'oui', '123 Paris', 'https://linkedin.com/in/test', 'Test Function', 'Test Prev Function', '28/01/2019', 'Coaching individuel', 'Test', 'Name', 'test@example.com', '0123123123'],
        ];

        $file = $this->generateTestFile($data);

        $this->expectException(InvalidUsersXlsx::class);
        $this->importUsers->import($file, $this->envVarHelper->fetch(EnvVarHelper::ROOT_PATH));
    }
    ...
    public function testImportErrorInvalidCompany(): void
    {
        $data = [
            ['Civility', 'First Name', 'Last Name', 'Email', 'Phone', 'Type', 'Role(s)', 'Company Name', 'Coach Email', 'Actif', 'Address', 'LinkedIn', 'Function', 'Previous Function', 'Seniority Date'],
            ['M', 'Test', 'User', 'first@testuser.com', '123123123', 'Candidat', 'Administrateur', 'Test Company', $this->loggedUser->getEmail(), 'oui', '123 Paris', 'https://linkedin.com/in/test', 'Test Function', 'Test Prev Function', '28/01/2019', 'Coaching individuel', 'Test', 'Name', 'test@example.com', '0123123123'],
        ];
    ...
    public function testImportErrorInvalidRole(): void
    {
        $data = [
            ['Civility', 'First Name', 'Last Name', 'Email', 'Phone', 'Type', 'Role(s)', 'Company Name', 'Coach Email', 'Actif', 'Address', 'LinkedIn', 'Function', 'Previous Function', 'Seniority Date'],
            ['M', 'Test', 'User', 'first@testuser.com', '123123123', 'Candidat', 'Invalid Role', 'Test Company Name', $this->loggedUser->getEmail(), 'oui', '123 Paris', 'https://linkedin.com/in/test', 'Test Function', 'Test Prev Function', '28/01/2019', 'Coaching individuel', 'Test', 'Name', 'test@example.com', '0123123123'],
        ];
    ...
    public function testImportMultipleErrors(): void
    {
        $data = [
            ['Civility', 'First Name', 'Last Name', 'Email', 'Phone', 'Type', 'Role(s)', 'Company Name', 'Coach Email', 'Actif', 'Address', 'LinkedIn', 'Function', 'Previous Function', 'Seniority Date'],
            ['M', '', 'User', 'first@testuser.com', '11211', 'test', 'Invalid Role', 'Test Company Name', $this->loggedUser->getEmail(), 'oui', '123 Paris', 'https://linkedin.com/in/test', 'Test Function', 'Test Prev Function', '28/01/2019', 'Coaching individuel', 'Test', 'Name', 'test@example.com', '0123123123'],
        ];
