...
final class CreateUserTest extends ApplicationTestCase
{
     ...
     */
    public function testCreate(?string $email = null, ?string $coach = null, ?string $userType = null, ?string $company = null, ?array $roles = null, ?string $profilePicture = null, ?bool $status = true, ?string $programType = null, ?string $exceptionClass = null, ?string $exceptionContains = null): void
    {
        ...
        $programType = $programType ?? $this->faker->name;
        ...
        if ($userType === UserTypeEnum::CANDIDATE) {
            ...
            $this->assertEquals($programType, $user->getProgramType());
        } else {
    ...
    public function userTestDataProvider(): array
    {
        return [
            ...
            'Failure because missing programType for candidate' => [
                'email' => null,
                'coach' => null,
                'userType' => UserTypeEnum::CANDIDATE,
                'company' => null,
                ...
                'status' => true,
                'programType' => '',
                'exceptionClass' => InvalidData::class,
                'exceptionContains' => null,
            ],
        ];
    }
