...
export default {
  ...
  data: () => ({
    ...
    actions: {
      ...
      download: {
        icon: "download",
        labelToolTip: "Télécharger"
      },
      mail: {
        icon: "icon-msg-primary",
        labelToolTip: "Mail de bienvenue",
      },
      expand: {
        icon: "see",
        labelToolTip: "Voir les événements"
      },
      collapse: {
        icon: "see",
        labelToolTip: "Collapse"
      },
    },
    showActions: null,
    page: 1,
