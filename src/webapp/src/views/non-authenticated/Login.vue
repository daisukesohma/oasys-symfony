          ...
          <div class="card-body">
            ...
            <form class="form-signin">
              ...
              <div class="form-group">
                ...
                />
                <img class="form-control-icon" v-else src="@/assets/img/password-primary.svg" />
      ...
      this.$validator.validateAll().then(result => {
        if (result) {
          this.$apollo.mutate({
              ...
              if (typeof this.$route.params.next !== 'undefined') {
                this.$router.push({
                  name: this.$route.params.next.name,
                  params: this.$route.params.next.params,
                  query: this.$route.params.next.query,
                });
              } else if (login && login.roles) {
                  if (login.type === 'candidate') {
                    this.$router.push({ name: 'CandidateHome' })
                  } else if (login.type === 'coach') {
                    this.$router.push({ name: 'CoachDashboard' });
                  } else if (login.roles.includes("ROLE_CREATE_USER")) {
