            ...
            <div class="panel panel-default">
              <div class="panel-body">
                ...
                <div class="form-row">
                  <div class="col-md-11">
                    <upload-file-drop
                        label="Cliquez ici pour ajouter votre fichier pour les fonctions et services"
                        :is-excel="true"
                        @select-file="savefile"
                        @remove-file="removefile" />
                  </div>
                </div>
                <div class="form-row" v-if="functionsServicesFileUrl">
                  <div class="col-md-11">
                    <a :href="functionsServicesFileUrl" target="_blank" class="btn btn-primary">
                      <i class="fa fa-download" /> Téléchargez le fichier existant
                    </a>
                  </div>
                </div>
              </div>
...
export default {
  ...
  apollo: {},
  computed: {
    functionsServicesFileUrl () {
      if (!this.company.functionsServicesFile) {
        return '';
      }
      ...
      return baseUrl + FILE_PATH + this.company.functionsServicesFile.id;
    },
  },
  methods: {
    savefile(file) {
