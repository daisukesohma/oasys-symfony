    ...
    <div class="container text-left user-form mb-5">
      <template v-if="!$apollo.loading">
        ...
        <div class="content flex-grow-1">
          <div class="mon-compte-btn-actions">
            <button
            ...
            <button class="btn btn-white-primary btn-cs px-4 ml-2 d-md-none" @click="logout">
              <img src="@/assets/img/deconnection-sm.svg" alt />
              Déconnexion
            </button>
            <button class="btn btn-white-primary btn-cs px-4 ml-2" v-if="isCoach"
                    @click="$router.push({name: 'CoachCalendar'})">
              Voir mon calendrier
            </button>
          </div>
          <form>
